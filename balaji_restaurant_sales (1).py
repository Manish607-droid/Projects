...
dataset = pd.read_csv(r"C:\Users\LENOVO\OneDrive\Desktop\Data_Analysis class Mindrisers\Mindrisers project\EDA SELF PROJECT\uncleaned data project\Balaji Fast Food Sales.csv")
dataset
...
def connect_with_psycopg2():
    try:
        ...
        connection = psycopg2.connect(
            ...
            database="Balaji Restaurant", # replace with your database name
            user="postgres",    # replace with your username
            password="manishmessi", # replace with your password
...
def load_csv_to_postgres(csv_file, table_name):
    try:
        # Read the CSV file
        df = pd.read_csv(r"C:\Users\LENOVO\OneDrive\Desktop\Data_Analysis class Mindrisers\Mindrisers project\EDA SELF PROJECT\Cleaned dataset downloaded from jupiter (CSV)\Balaji Restaurant cleaned.csv")
        ...
        engine = create_engine('postgresql://postgres:manishmessi@localhost:5432/Balaji Restaurant')
