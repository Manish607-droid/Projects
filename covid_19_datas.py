...
print(correlation1)
# There is a positive relationship between confirmed and recovered. This shows that countries which has
# Higher confirmed cases also have higher recovery cases. But since it is not very high therefore, it might be
# due to the country's health infrastructure and people awareness.

# correlation between confirmed and deaths
correlation2 = dataset[['Confirmed','Deaths']].corr()
print(correlation2)
# There is a strong postivie correlation between confirmed cases and deaths which shows
# that higher cases also leads to higer number of deaths.
...
# This means if there are high number of recoveries then it leads to
# high number of deaths. It is mainly because of the increase in high number
# of reported cases.
...
1.   USA has the highest number of deaths and reported cases of COVID-19 for the month of April followed by spain and Italy.

2.   Simiarly, for the recovered cases Spain has the highest followed by US and Germany.

3. From this data we can know that Spain has good health infrastructre as they have highest recovered cases even when it is one of the top countries for reported cases and deaths.

4. Although countries like Italy and UK fall under one of the highest
death and reported cases but in terms of recovery they are little behind which shows their healthcare infrastructure is quite not up to the top.
