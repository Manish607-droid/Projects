...
1. The campaign done through the influencers resulted in high ROI (5.011) in average followed by Search(5.008) and Display(5.006). This shows that people tend to use the products advertised by the influencers. Hence, Companies can hire different influencers for sponsoring their products.
...
3. Men aged between 18-24 had the highest conversion rate (8.023) at Food related products (5.0043). This gives the insights that businesses should mainly target the food products in marketing which are favoured by men aged betwee 18-24. Therefore, Companies selling the food related products can focus more on the food which is favoured by the 18-24 range age groups.

4. Miami generates the highest ROI (5.012). Since, Miami is a tourist spot so the marketing campaign done on Miami goves higher ROI. So, Places similar to Miami can be targeted for marketing campaign to generate higher ROI.
