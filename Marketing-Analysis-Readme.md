...
The dataset is fictional, which is the primary limitation. 
The near-zero correlations between most variables and the very small differences in ROI across segments are a direct 
result of this — real campaign data would show much stronger patterns and variance.
The findings here are useful for practising the analytical process, but should not be taken as representative
of actual marketing performance.
