...
1. The campaign done through the influencers resulted in high ROI (5.011) in average followed by Search(5.008) and Display(5.006). This indicates that people tend to use the products advertised by the influencers. Hence, Companies can hire different influencers for sponsoring their products.

2. Facebook performed the best in terms of average ROI (5.018) followed by Websites (5.014) and Gogle Ads (5.003). This shows that Facebook is considered the best marketplace for marketing campaign since it is used by people of all age. Therefore, increase in budget in Facebook marketing can be mmore beneficial for the companies products.

3. Men aged between 18-24 had the highest conversion rate (8.023) at Food related products (5.0043). This suggests that businesses should mainly target the food products in marketing which are favoured by men aged betwee 18-24. Therefore, Companies selling the food related products can focus more on the food which is favoured by the 18-24 range age groups.

4. Miami generates the highest ROI (5.012). Since, Miami is a tourist spot so the marketing campaign done on Miami gives higher ROI. So, Places similar to Miami can be targeted for marketing campaign to generate higher ROI.

5. The relationship between Conversion rate and ROI(-0.001) is close to zero.This means Conversion rate does not necessarily result in increase in ROI.

6. There is a little positive relation between Engagement Score and  ROI (0.00058).This indicates Higher engagement score does not necessarily lead to increase in ROI.
